import statsMock from '@/mock/statistika'
...
export function StatsSection() {
    const items = [
        { value: `${statsMock.market_count}`, label: 'Market sayı', icon: <StoreIcon /> },
        { value: `${statsMock.region_count}`, label: 'Region', icon: <MapPinIcon /> },
        { value: `${statsMock.product_count}+`, label: 'Məhsul sayı', icon: <BoxIcon /> },
        { value: `${statsMock.employee_count}+`, label: 'Əməkdaş sayı', icon: <UsersIcon /> },
    ]
