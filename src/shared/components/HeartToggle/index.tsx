        ...
        return (
            <Button
                ...
                className={`absolute right-3 top-3 z-10 flex h-9 w-9 items-center justify-center rounded-[8px] backdrop-blur-sm transition-all duration-200 ease-out hover:scale-110 active:scale-90 ${
                    isFavorite
                        ? 'bg-danger/15 shadow-[0_2px_10px_rgba(244,166,166,0.45)]'
            ...
            >
                <Heart
                    ...
                    className={`transition-all duration-200 ${
                        isFavorite ? 'scale-110 fill-danger text-danger' : 'text-neutral-400'
                    }`}
                />
            </Button>
        )
    ...
    return (
        ...
        >
            <Heart
                size={24}
                strokeWidth={2}
                className={isFavorite ? 'fill-danger text-danger' : 'text-neutral-700'}
            />
        </Button>
    )
}
